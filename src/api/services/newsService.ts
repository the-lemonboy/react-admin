...
export enum NewsType {
  ...
  AddTheasaurus = '/api/media/content/area/add',
  ChangeTheasaurusStatus = '/api/media/content/area/opt_status',
  UpdateNews = '/api/news/update',
  DeleteNews = '/api/news/delete',
  GetTheasaurusList = '/api/media/content/area/list',
  GetCategoryList = '/api/media/content/category/list',
  AddCategory = '/api/media/content/category/add',
  UpdateCategory = '/api/media/content/category/update',
  SearchNewsList = '/api/media/flashnews/search',
  GetChildCateGory = '/api/media/content/level/category/list',
  NewsList = '/api/media/flashnews/list',
  ArticelList = '/api/media/news/search',
  ChangeCategoryStatus = '/api/media/content/category/opt_status',

...
import twitterService, { AddCategoryReq } from '@/api/services/twitterService';
...
EditorOrAddModelProps) {
  ...
  const createMediaMutation = useMutation({
    mutationFn: async (params: AddCategoryReq) => {
      const res = await twitterService.AddCateGory(params);
      return res.data;
    },
    onSuccess: () => {
  ...
  const updateCategoryMutation = useMutation({
    mutationFn: async (params: AddCategoryReq) => {
      const res = await twitterService.UpdateCategory(params);
      return res.data;
    },
    onSuccess: () => {
      queryClient.invalidateQueries(['PlanetCategroyList']);
